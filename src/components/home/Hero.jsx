...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-linear-to-br from-slate-50 via-white to-yellow-50/50">
      {/* Abstract Background Elements */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* Large gradient orbs */}
        <div className="absolute -top-40 -right-40 w-150 h-150 bg-yellow-400/15 rounded-full blur-3xl" />
        <div className="absolute top-1/2 -left-40 w-125 h-125 bg-yellow-600/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-100 h-100 bg-orange-400/10 rounded-full blur-3xl" />
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[55%] h-full hidden xl:flex items-center justify-center" style={{ perspective: '1200px' }}>
          ...
          >
            ...
            >
              ...
              {/* Label Card */}
              <div className="absolute bottom-5 left-5 right-5 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/50">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-32 pb-20">
        <div className="max-w-4xl">
          ...
          >
            <H1 className="leading-tight text-gray-900">
              ...
              <span className="relative inline-block">
                <span className="text-yellow-600">Modern Interiors</span>
                <motion.span
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  transition={{ delay: 1, duration: 0.8 }}
                  className="absolute -bottom-2 left-0 right-0 h-1 bg-yellow-600 rounded-full origin-left"
                />
              </span>
            </H1>
          ...
          >
            <Link to="/products">
              <Button variant="primary" size="lg" icon={ChevronRight} className="bg-yellow-600 text-white hover:bg-yellow-700 shadow-lg shadow-yellow-600/30 border-0">
                Explore Product Range
              </Button>
            </Link>
            <a href="/catalogue.pdf" download>
              <Button variant="secondary" size="lg" icon={Download} iconPosition="left" className="bg-white text-gray-900 hover:bg-gray-50 border border-gray-200 shadow-lg shadow-gray-900/10">
                Download Catalogue
              </Button>
            </a>
            <Link to="/contact">
              <Button variant="secondary" size="lg" className="bg-gray-900 text-white hover:bg-gray-800 border-0 shadow-lg shadow-gray-900/20">
                Become a Dealer
              </Button>
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-10 border-t border-gray-200"
          >
